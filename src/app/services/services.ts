...
export class ApiService {
  ...
  getWork(worktypeid: number): Observable<Work[]> {
    ...
    return this.http.get<Work[]>(this.apiUrl + '/GetWorkByType', { params: queryParams });
  }

  // GET request to fetch data
  getTechnology(technologytypeid: number): Observable<Technology[]> {
    const queryParams = new HttpParams().set('technologytypeid', technologytypeid.toString());
